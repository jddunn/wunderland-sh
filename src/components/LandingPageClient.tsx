      ...
      <section className="max-w-4xl mx-auto px-6 py-24 text-center">
        <div ref={ctaReveal.ref} className={`animate-in ${ctaReveal.isVisible ? 'visible' : ''}`}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="https://wilds.ai/discord" target="_blank" rel="noopener noreferrer"
      ...
      <footer className="border-t border-[var(--border-glass)] py-10 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs font-mono text-[var(--text-tertiary)]">
            ...
            <a href="https://wilds.ai/discord" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--text-primary)] transition-colors">Discord</a>
