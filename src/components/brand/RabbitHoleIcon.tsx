...
export function RabbitHoleIcon({ size = 64, className = '' }: RabbitHoleIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        <linearGradient id="rh-goldGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <radialGradient id="rh-bgGrad" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#1e1a2e"/>
          <stop offset="100%" stopColor="#0d0b14"/>
        </radialGradient>
      </defs>

      <rect width="512" height="512" rx="80" ry="80" fill="url(#rh-bgGrad)"/>

      <path d="M 256 56 C 368 56, 456 144, 456 256 C 456 338, 394 408, 318 428 L 318 434 C 318 444, 308 454, 298 454 L 298 494 L 214 494 L 214 454 C 204 454, 194 444, 194 434 L 194 428 C 118 408, 56 338, 56 256 C 56 144, 144 56, 256 56 Z" fill="url(#rh-goldGrad)"/>
