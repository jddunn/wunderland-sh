 ...
 *
 * Renders a hexagonal radar with glowing vertices, gradient fill,
 * and pulsing data points. Each axis represents one HEXACO dimension.
 */
...
const TRAIT_KEYS = ['honesty', 'emotionality', 'extraversion', 'agreeableness', 'conscientiousness', 'openness'];
const TRAIT_COLORS = [
  '#ff6b9d', // H - pink
  '#c084fc', // E - purple
  '#fbbf24', // X - gold
...
export function HexacoRadar({
  ...
  const traitValues = useMemo(
    () => TRAIT_KEYS.map((key) => traits[key] ?? 0.5),
    [traits]
  );
