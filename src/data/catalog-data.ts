...
export const TOOL_CATALOG: ToolEntry[] = [
  ...
  { packageName: '@framers/agentos-skills', name: 'skills', category: 'tool', displayName: 'Skills Registry', description: 'Discover and enable curated SKILL.md prompt modules.', requiredSecrets: [] },
